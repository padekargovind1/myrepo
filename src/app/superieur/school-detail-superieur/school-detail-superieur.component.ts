...
@Component({
  ...
  templateUrl: './school-detail-superieur.component.html',
  styleUrls: ['./school-detail-superieur.component.scss']
})
export class SchoolDetailSuperieurComponent implements OnInit {

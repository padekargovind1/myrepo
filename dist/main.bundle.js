...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_slick_carousel_slick_slick__ = __webpack_require__("../../../../slick-carousel/slick/slick.js");
...
var LinguisticComponent = (function () {
    function LinguisticComponent(schoolService, location) {
        this.schoolService = schoolService;
        this.location = location;
        this.getTrips();
    }
    ...
    LinguisticComponent.prototype.getTrips = function () {
        ...
        this.schoolService.getTrips()
            ...
            if (data.code == 400) {
                ...
                for (var i = 0; i < _this.listTrips.length; i++) {
                    _this.listTrips[i].class = "school-carousel" + i;
                    _this.listTripsFiltered[i].class = "school-carousel" + i;
                }
...
LinguisticComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_school_service__["a" /* SchoolService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_school_service__["a" /* SchoolService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_common__["Location"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_common__["Location"]) === "function" && _b || Object])
], LinguisticComponent);
